  ...
  return (
    <>
      <Box sx={{ position: "relative", height: "100vh" }}>
        ...
        >
          <Typography sx={{ letterSpacing: "2px", fontFamily: "Quicksand" }}>
            Shop All
          </Typography>
          <Typography sx={{ letterSpacing: "2px", fontFamily: "Quicksand" }}>
            Computers
        ...
        <Box mt={13} ml={20} width={"50%"}>
          <Typography
            p={"1px 15px"}
            width={"max-content"}
            sx={{ backgroundColor: "#f43a09", color: "white" }}
          >
            Best Prices
          </Typography>
          <Typography variant="h2" mt={2} fontFamily={"Trebuchet MS"}>
      ...
      <Box sx={{ display: "grid", gridTemplateColumns: "1fr 1fr" }}>
        ...
        >
          <Typography variant="h3" mt={5} fontFamily={"Quicksand"}>
            About Us
          </Typography>
          <Typography
            fontSize={"20px"}
